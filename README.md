# stacksmith-ci-example [![Build Status](https://travis-ci.com/kevfranklin66/stacksmith-ci-example.svg?branch=master)](https://travis-ci.com/bitnami-labs/stacksmith-ci-example)
